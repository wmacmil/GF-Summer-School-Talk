...
% \begin{Itemize}
% \item Formal Proof
%   for computer (or aliens)
%   translation via compiler (i.e. to kernel, or other langauge)
%   objective
%   syntax oriented
%   20th century
%   unstated obligations inferable 
%   computer verified
%   unambiguous, possibly redundant
%   semantic structure distributed in variable names and comments
  

% \item Informal Proof
%   for human
%   translation requires human
%   subjective
%   semantics oriented
%   >= Euclid
%   some obligations require domain expertise
%   peer reviewed
%   ambiguous (to non-experts), possibly redundant
%   syntax both structured and unstructured.

%   % aliens vs humans
%   % this is a spectrum
%   % the meaning of evidence clearly varies based off when in time you're
%   % speaking about and who youre talkin to
% \item Types, on the other hand, are often ambiguous
% \end{itemize}
